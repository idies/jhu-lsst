...
SELECT * FROM lsst.Object WHERE deepSourceId = 16968353272299750
...
SELECT ra , decl , u_psfFlux , g_psfFlux , r_psfFlux FROM lsst.Object WHERE y_shapeIxx BETWEEN 20 AND 20.2

-- SELECT COUNT(*) FROM Source WHERE flux\_sinc BETWEEN 1 AND 1.1
 SELECT COUNT(*) FROM lsst.Source WHERE flux_sinc BETWEEN 1 AND 1.1
...
*/
SELECT o.deepSourceId , s. objectId , s.id , o.ra , o. decl 
  FROM lsst.Object o, lsst.Source s
 WHERE o.deepSourceId=s.objectId  
   AND s.flux_sinc BETWEEN 0.3 AND 0.31
