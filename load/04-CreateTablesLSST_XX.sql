...
alter table Object_04
add constraint pk_object_04
...
alter table source_04 
add CONSTRAINT [pk_source_04_id] PRIMARY KEY CLUSTERED 
(
	[id] ASC
...
/****** Object:  Table [dbo].[ForcedSource_04]    Script Date: 3/5/2018 12:51:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[ForcedSource_04](
	[deepSourceId] [bigint] NOT NULL,
...
ALTER TABLE [ForcedSource_04]
 ADD CONSTRAINT [pk_fsource_04_dsid_ccdid] PRIMARY KEY CLUSTERED 
(
	[deepSourceId] ASC,
	[scienceCcdExposureId] ASC
)WITH (SORT_IN_TEMPDB=ON, DATA_COMPRESSION = PAGE, PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [FS_04]


GO
---------------------------------------------------------------------------------------------------------------------

CREATE TABLE [dbo].[ObjectFullOverlap_04](
	[deepSourceId] [bigint] NOT NULL,
	[ra] [real] NOT NULL,
	[decl] [real] NOT NULL,
	[raVar] [real] NULL,
...
CREATE CLUSTERED INDEX [idx_objflolap_dpsrcid] ON [dbo].[ObjectFullOverlap_04]
(
	[deepSourceId] ASC
)WITH (sort_in_tempdb = on, data_compression=page)
on obj_04
